...
class cPanelApi
{
    ...
    private $cPanelUser = null;
    private $cPanelPwd = null;
    private $cPanelUrl = null;
    private $cPanelPort = 2083;

     /**
     * Constructor for initializing the cPanel API connection.
     *
     * @param mixed $cpanelUrl The URL of the cPanel.
     * @param mixed $cpaneluser The username for cPanel login.
     * @param mixed $cpanelPwd The password for cPanel login.
     * @param string $cpanelPort The port for cPanel API (default: '2083').
     */
